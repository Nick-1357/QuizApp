...
const quizAppQuestion = require("./QuizAppQuestions");
...
//Retrive all QuizAppQuestions
app.get("/retrive", async function (req, res) {
  ...
  quizAppQuestion
    ...
    .catch((err) => {
      res.status(500).send({
        message: "Some error occured while retriving questions",
        error: err,
      });
    });
});
